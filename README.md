...
- Rows 2 through 48 contain PCA scores for all North American T. repens populations of origin
- Rows 49 through 97 contain PCA scores for all European T. repens populations of origin
- Row 98 contains PCA scores for the Lafayette, LA, USA common garden location
- Row 99 contains PCA scores for the Mississauga, ON, Canada common garden location
- Row 100 contains PCA scores for the Montpellier, France common garden location
- Row 101 contains PCA scores for the Uppsala, Sweden common garden location

3. All identifying, genotyping, and fitness data for all individual T. repens plants in each common garden can be found in Albano_et_al_2025_EM_Experiment_Data.csv The columns contained within this dataset are explained below and are analyzed in Albano_et_al_2025_EM_Analysis.r
...
- Ac_ac_Num: Binomial representation of the Ac_ac column (Ac = 1, ac = 0)
- Li_li: Describes whether or not a plant contains at least one dominant allele at the Li/li locus (Li = yes, li = no)
- Li_li_Num: Binomial representation of the Li_li column (Li = 1, li = 0)
